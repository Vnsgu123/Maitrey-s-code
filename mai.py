...
def control_logic(sim):
	...
	while bb:
		...
		while m:
			...
			if (distance_11==0) and (distance_22 >= 0.166 and distance_22 <= 0.1804):
				print("@@@@@@@")
		...
		while t3:
			...
			print("--------",diff)
			if diff < 0.025 and diff > -0.025 and distance_3 > 0:
				print("iiiiii")
				t3=0
				# yy=1s
				sim.setJointTargetVelocity(e,0.7)
		...
		while m3:
			...
			if (distance_11==0) and (distance_33 >= 0.160 and distance_33 <= 0.1704):
				print("@@@@@@@")
				# sim.setJointTargetVelocity(r,0)
				# sim.setJointTargetVelocity(e,0)
				# sim.setJointTargetVelocity(r,2)
		...
		while m4:
			...
			distance_33 = detect_distance_sensor_3(sim)
			print(distance_33,distance_11)
			if (distance_11==0) and (distance_33 >= 0.160 and distance_33 <= 0.1845):
				print("@@@@@@@")
				# sim.setJointTargetVelocity(r,0)
				# sim.setJointTargetVelocity(e,0)
				# sim.setJointTargetVelocity(r,2)
		...
		while t5:
			...
			diff=distance_1 - distance_3
			print("--------",diff)
			if diff < 0.015 and diff > -0.01 and distance_3 > 0:
				print("iiiiii")
				t5=0
				# yy=1s
				sim.setJointTargetVelocity(e,0.7)
		...
		while m5:
			...
			distance_33 = detect_distance_sensor_3(sim)
			print(distance_33,distance_11)
			if (distance_11==0) and (distance_33 >= 0.120 and distance_33 <= 0.194):
				print("@@@@@@@")
				# sim.setJointTargetVelocity(r,0)
				# sim.setJointTargetVelocity(e,0)
				# sim.setJointTargetVelocity(r,2)
		...
		while t6:
			...
			diff=distance_1 - distance_2
			print("--------",diff)
			if diff < 0.038 and diff > -0.038 and distance_2 > 0:
				print("iiiiii")
				t6=0
				# yy=1s
				sim.setJointTargetVelocity(r,0.7)
		...
		while m6:
			...
			distance_22 = detect_distance_sensor_2(sim)
			print(distance_22,distance_11)
			if (distance_11==0) and (distance_22 >= 0.166 and distance_22 <= 0.2226):
				print("@@@@@@@")
				# sim.setJointTargetVelocity(r,0)
				# sim.setJointTargetVelocity(e,0)
				# sim.setJointTargetVelocity(r,2)
		...
		while t7:
			...
			diff=distance_1 - distance_2
			print("--------",diff)
			if diff < 0.048 and diff > -0.048 and distance_2 > 0:
				print("iiiiii")
				t7=0
				# yy=1s
				sim.setJointTargetVelocity(r,0.7)
		...
		while m7:
			...
			distance_22 = detect_distance_sensor_2(sim)
			print(distance_22,distance_11)
			if (distance_11==0) and (distance_22 >= 0.166 and distance_22 <= 0.2265):
				print("@@@@@@@")
				# sim.setJointTargetVelocity(r,0)
				# sim.setJointTargetVelocity(e,0)
				# sim.setJointTargetVelocity(r,2)
